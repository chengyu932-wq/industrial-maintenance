...
public class RepairRequestService {
    ...
    private final EquipmentStateService equipmentStates;private final WorkOrderStateService states;private final WorkOrderService workOrders;
    public RepairRequestService(WorkOrderMapper mapper,WorkOrderScopeService scopes,BusinessNumberService numbers,EquipmentStateService equipmentStates,WorkOrderStateService states,WorkOrderService workOrders){this.mapper=mapper;this.scopes=scopes;this.numbers=numbers;this.equipmentStates=equipmentStates;this.states=states;this.workOrders=workOrders;}
