...
public record WorkOrderListVO(Long id,String workOrderNo,WorkOrderType workOrderType,Long repairRequestId,
    ...
    LocalDateTime completedAt,Integer acceptanceReturnCount,Long pmPlanId,Long slaRuleId,
    LocalDateTime slaResponseDeadline,LocalDateTime slaResolveDeadline) {}
