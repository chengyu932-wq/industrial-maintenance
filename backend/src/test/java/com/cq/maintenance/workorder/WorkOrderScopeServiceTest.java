...
class WorkOrderScopeServiceTest {
    ...
    WorkOrderListVO summary(Long reporter){return new WorkOrderListVO(1L,"WO",WorkOrderType.REPAIR,2L,"RR",3L,"E","设备",4L,"车间",null,WorkOrderStatus.PENDING_ACCEPT,reporter,"报修人",7L,"工程师",8L,"班组",null,null,null,null,null,null,0,null,null,null,null);}
